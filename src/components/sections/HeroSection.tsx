...
export default function HeroSection() {
    return (
        <div className="flex overflow-x-auto snap-x snap-mandatory gap-4 pb-4 px-4 md:px-0 -mx-4 md:mx-0 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            <section className="relative w-[92vw] sm:w-[95vw] md:w-full shrink-0 snap-center rounded-[32px] overflow-hidden bg-linear-to-r from-[#ff4700] to-[#ff6a30] px-6 py-10 md:p-14 flex flex-col md:flex-row items-center justify-between min-h-[420px] shadow-sm">
