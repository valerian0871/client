...
export default function BestSellers() {
    return (
        <section className="mb-16">
            ...
            <div className="flex overflow-x-auto snap-x snap-mandatory gap-4 pb-6 px-4 md:px-0 md:flex-wrap md:justify-center xl:justify-start lg:gap-6 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
