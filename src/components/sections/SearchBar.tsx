...
export default function SearchBar() {
    return (
        <div className="w-full max-w-[1334px] mx-auto px-4 md:px-0 my-8">
            <div className="w-full flex items-center bg-white border border-gray-200 rounded-full px-5 py-3 md:py-3.5 shadow-sm focus-within:ring-4 focus-within:ring-[#f95e34]/10 focus-within:border-[#f95e34]/50 transition-all group">
