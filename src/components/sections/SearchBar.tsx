...
export default function SearchBar() {
    return (
        <div className="w-full flex items-center gap-3 my-8">
            <div className="flex-1 flex items-center bg-white border border-gray-200 rounded-full px-4 py-3 md:px-5 md:py-3.5 shadow-sm focus-within:ring-4 focus-within:ring-[#f95e34]/10 focus-within:border-[#f95e34]/50 transition-all group">
                ...
                <input 
                    ...
                    className="flex-1 bg-transparent px-3 outline-none text-gray-800 text-sm md:text-[15px] font-semibold placeholder:text-gray-400 placeholder:font-medium"
                />
            </div>
